...
export const storageKeys = {
  ...
  rooms: 'catalyx-rooms',
  tents: 'catalyx-tents',
  plants: 'catalyx-plants',
  photos: 'catalyx-photos',
  dailyCheckIns: 'catalyx-daily-check-ins',
  feedLogs: 'catalyx-feed-logs',
  environmentLogs: 'catalyx-environment-logs',
  journalEntries: 'catalyx-journal-entries',
  reminders: 'catalyx-reminders',
  pushSubscription: 'catalyx-push-subscription',
  shelf: 'catalyx-shelf',
  rewardRedemptions: 'catalyx-reward-redemptions',
  cxRewardsState: 'catalyx-cx-rewards-state',
  cxRewardsConfig: 'catalyx-cx-rewards-config',
  cxRewardsCatalog: 'catalyx-cx-rewards-catalog',
}
